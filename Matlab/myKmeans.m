...
%     if assignment(i)==1
%         type = '+';
%     elseif assignment(i)==2
%         type = 'o';
%     elseif assignment(i)==3
%         type = '*';
%     elseif assignment(i)==4
%         type = 'x';
%     elseif assignment(i)==5
%         type = 's';
%     elseif assignment(i)==6
%         type = 'd';
%     elseif assignment(i)==7
%         type = '^';
%     elseif assignment(i)==8
%         type = 'v';
%     elseif assignment(i)==9
%         type = '>';
%     end
%     scatter(data(i,1),data(i,2),type);
% end