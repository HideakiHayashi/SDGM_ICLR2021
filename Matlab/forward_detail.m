%======================================
%forward calculation (return detailed information)
%======================================
function [I2, exI2, O2, Y] = forward_detail(w, Phi, mixture, param,usedWeightFlag)
I2 = zeros(param.N, param.tCompNum-1);      %
...
%             exI2(:,param.pastCompNum(c)+m) = exp(Phi*w(param.pastCompNum(c)*param.H+(m-1)*param.H+1:param.pastCompNum(c)*param.H+m*param.H));
            ...
            I2(:,param.pastCompNum(c)+m) = Phi(:,tmpUsed)*tmp_w(tmpUsed);
